...
export default function Capsula(props: any) {
  ...
  if(new Date() < open_date){
    ...
    return(
      <div className="xl:w-[70%] md:w-[80%] sm:w-[100%] h-[300px] cursor-pointer  zig-zag-capsule items-center flex flex-col bg-gradient-to-b bg-black hover:capsule-hover rounded-t-[2vh]">
    ...
    return (
      ...
      <div className="xl:w-[70%] md:w-[80%] sm:w-[100%] h-[300px] cursor-pointer  zig-zag-capsule items-center flex flex-col bg-gradient-to-b from-indigo-700 from-5%  to-purple-600 to-100% hover:capsule-hover rounded-t-[2vh]" onClick={ViewText}>
        <h1 className="text-2xl w-full mt-3 text-white  text-center">{props.number}. {props.text}</h1>
        <div className="w-[10vw] h-[.5vh] rounded-full mt-3 bg-black" ></div>
